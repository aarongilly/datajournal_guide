...
This example Data Journal shows what [[meta/OLD-Reference Build/OLD-The Reference Build - a Complete Data Journal Architecture]] looks like when it's operating. Use [[meta/OLD-Reference Build/OLD-The Reference Build - a Complete Data Journal Architecture|the Reference Build Guide]] to create your own.
## Layers
...
This example is the [[meta/OLD-Reference Build/OLD-The Reference Build - a Complete Data Journal Architecture|Reference Build]] filled with fictitious data. 
...
> [!success]  How to...
> [[meta/OLD-Reference Build/OLD-Layer 0 – Data Store]] shows how to build this *(including the actual Google Sheet)*
...
> [!success]  How to...
> [[OLD-Layer 1 – Automations]] shows how to build this *(including the actual Google Apps Script Code)*
...
> [!success]  How to...
> [[meta/OLD-Reference Build/OLD-Layer 2 – Integrations]] shows how to build this *(including the actual Google Apps Script Code)*
...
> [!success]  How to...
> [[meta/OLD-Reference Build/OLD-Layer 3 – Fast Input]] shows how to build this
...
> [!success]  How to...
> [[meta/OLD-Reference Build/OLD-Layer 4 – Widgets]] shows how to build this *(including the actual Scriptable code)*
