...
> 	- [[Layer 4 – Widgets|Step 4]] 👈 you are here
...
With [[Layer 2 – Integrations]] you created a URL that allows other tools to retrieve your Data Journal data in JSON format. That means you can get to that data via anything that can make a web request.
