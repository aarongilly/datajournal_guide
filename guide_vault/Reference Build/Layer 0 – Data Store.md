...
> - How-tos:
> 	- [[Layer 0 – Data Store|Step 0]] 👈 you are here
> 	- [[Layer 1 – Automation|Step 1]]
> 	- [[Layer 2 – Integrations|Step 2]]
> 	- [[Layer 3 – Fast Input|Step 3]]  
> 	- [[Layer 4 – Widgets|Step 4]]

The [[The Reference Build - a Complete Data Journal Architecture|Reference Build]] is based on Google Sheets.
...
| ----------------------------------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------ |
| [[Example Data Journal#Days\|days]]             | One day                | The bread & butter of a Data Journal. One row per day.                                                 |
| [[Example Data Journal#Weeks\|weeks]]           | One week               | Mostly formulas + one per-week data point.                                                             |
| [[Example Data Journal#Months\|months]]         | One month              | Mostly formulas + some monthly data points.                                                            |
| [[Example Data Journal#Years\|years]]           | One year               | Mostly formulas + a yearly data point.                                                                 |
| [[Example Data Journal#Workouts\|workouts]]     | One *workout*          | Example of a sheet whose rows are *per instance of a thing* rather than *per time period*.             |
| [[Example Data Journal#Events\|events]]         | One *event occurrence* | Another example showing how to handle data that doesn't neatly fit into a "per time period" structure. |
| [[Example Data Journal#PivotTable\|PivotTable]] | -                      | A PivotTable for ad hoc data analysis.                                                                 |

Each sheet is shown and documented extensively in [[Example Data Journal|The Example Data Journal Page]]. 
...
1. Read [[Example Data Journal#Layer 0 - Data Store|about the example Google Sheets Data Store]]
